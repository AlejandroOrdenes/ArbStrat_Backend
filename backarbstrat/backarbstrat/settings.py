"""
Django settings for backarbstrat project.
...
SECRET_KEY = 'django-insecure-yggeir@0wx5*(en2z2nq%)71t@2l5g@ib=tzw)s^v70=vsr7kk'
...
ROOT_URLCONF = 'backarbstrat.urls'
...
WSGI_APPLICATION = 'backarbstrat.wsgi.application'
...
# Configuración de Django para APScheduler
APSCHEDULER_DATETIME_FORMAT = 'timestamp'
